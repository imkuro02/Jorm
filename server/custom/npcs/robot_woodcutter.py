...
class CustomWoodcutterRobot(Npc):
    ...
    def spawn_footprints(self, dir):
        ...
        corpse.description = f'There is a set of tire tracks leading {dir.lower()}, you wonder what they belong to.'
        corpse.description_room = f'{Color.BAD}A pair of tire track is leading {dir.lower()}{Color.BACK}'
        corpse.stack_max = 1
        corpse.keep = False
