...
class SETTINGS:
    ...
    PROMPT = 'prompt'
    LIST_SETTINGS = [
        GMCP, ALIAS, VIEW_ROOM, VIEW_MAP, PVP, RESET, LOGOUT, DEBUG, PWD, USR, PROMPT
    ]
...
class Settings:
    def __init__(self, actor, aliases = None, gmcp = True, view_room = True, view_map = False, pvp = False, debug = False, prompt = None):
        ...
        self.prompt_default = {
            '0': 'LV.@yellow#LLVL# @normalHP.@bred#LHP# @normalMP.@cyan#LMP# @normalPA.@byellow#LPHYARM# @normalMA.@bcyan#LMAGARM# @normalTH.@red#LTHREAT#@normal',
