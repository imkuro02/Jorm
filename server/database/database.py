...
class Database:
    ...
    def write_actor(self, actor):
        ...
        my_dict["actor_time_in_game"] = actor.time_in_game + (
            systems.utils.get_unix_timestamp() - actor.date_of_last_login
        )
        ...
        for quest in actor.quest_manager.quests.values():
            ...
            for objective in quest.objectives.values():
                # systems.utils.debug_print(objective)
        ...
        for key in actor.friend_manager.friends:
            ...
            # systems.utils.debug_print(f'{actor_id} adds {key}')
            self.cursor.execute(
                """
                INSERT INTO friend (
                    actor_id, friend_id
    ...
    def read_actor(self, unique_id):
        ...
        # systems.utils.debug_print('inventory',inventory)
        ...
        # systems.utils.debug_print('equipment',equipment)
        ...
        # systems.utils.debug_print('skills',skills)
        ...
        # systems.utils.debug_print('quests',quests)
        ...
        # systems.utils.debug_print('bonuses', bonuses)
        ...
        for alias in settings:
            # systems.utils.debug_print(alias)
            my_dict["settings"][alias[1]] = alias[2]

        my_dict["friends"] = []
        if friends != None:
            for friend in friends:
                # systems.utils.debug_print('loading friend,',friend)
                my_dict["friends"].append(friend)
        # systems.utils.debug_print(my_dict['friends'])

        # systems.utils.debug_print(my_dict['settings_aliases'])
    ...
    def delete(self, username):
        ...
        if acc == None:
            systems.utils.debug_print("cant remove this pogchamp")
            return
        unique_id = acc[0]
        actor_id = acc[1]
